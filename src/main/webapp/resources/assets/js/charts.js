$(document).ready(function () {
    ...
    */
    ...
    if ($('.stats-bar')[0]) {
        sparklineBar('stats-bar', [100,200,300], '100px', 3, '#fff', 2);
    }
    ...
    if ($('.stats-pie')[0]) {
        sparklinePie('stats-pie', [20, 35, 30, 5], 80, 80, ['#fff', 'rgba(255,255,255,0.7)', 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.2)']);
    }
