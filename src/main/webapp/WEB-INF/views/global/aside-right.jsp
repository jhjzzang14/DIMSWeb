		...
		<div role="tabpanel" class="tab-pane fade in active" id="friends">
			<div class="listview">
				<a class="lv-item" href="">
					...
					<div class="media">
						<div class="pull-left">
							<img class="lv-img-sm" src="<c:url value="/assets/img/profile-pics/5.jpg"/>" alt="">
						</div>
						<div class="media-body">
					...
					<div class="media">
						<div class="pull-left">
							<img class="lv-img-sm" src="<c:url value="/assets/img/profile-pics/6.jpg"/>" alt="">
						</div>
						<div class="media-body">
					...
					<div class="media">
						<div class="pull-left p-relative">
							<img class="lv-img-sm" src="<c:url value="/assets/img/profile-pics/7.jpg"/>" alt="">
							<i class="chat-status-busy"></i>
						</div>
						<div class="media-body">
